...
// Explicit map so Tailwind JIT picks up all col-span-* classes. Mobile is a
// single column (the parent grid is grid-cols-1); colSpan only applies from md:
// up, where the 12-column desktop layout kicks in.
